...
<?php if ($_valid && !is_callable('content_50a26e194bd213_44565630')) {function content_50a26e194bd213_44565630($_smarty_tpl) {?>$(document).ready(function(){
    ...
    sliderOnStop = function(event, ui) {
        ...
        var urlPatern = '<?php echo '/*%%SmartyNocache:2922450a26e19407b59-73318580%%*/<?php echo smartyCreateUri(array(\'controller\'=>"timeline",\'action\'=>"ajaxUpdateList",\'params\'=>array("-YEAR-")),$_smarty_tpl);?>
